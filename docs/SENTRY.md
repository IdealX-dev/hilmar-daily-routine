...
**Schedule:** `7 8 * * 1-4` America/New_York (Mon-Thu 8:07 AM ET; reports the prior business day). Friday's 4:30 PM fire is covered by liveness, not this single-crontab monitor.
...
Then:
4. If Sentry sees NEITHER emitter within 290 min of 8:07 AM ET on a Mon-Thu →
